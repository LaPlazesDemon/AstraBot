...
module.exports = {
    ...
    async execute(interaction) {
        ...
        sql.query(`SELECT * FROM overwatch.userMessages WHERE c_id = ? AND m_sent_at > DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 1 DAY);`, [interaction.channel.id], function(err, result) {
            if (err) {
